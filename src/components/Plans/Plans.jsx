      ...
      <section className="py-6 bg-gray-100 text-gray-900">
        <div className="container mx-auto p-4 sm:p-10">
          <div className="mb-16 space-y-4 text-center">
            ...
            <div>
              <button className="px-4 py-1 font-semibold border rounded-l-lg bg-violet-600 border-violet-600 text-gray-50">
                Monthly
              </button>
              <button className="px-4 py-1 border rounded-r-lg border-violet-600">
                Annually
              </button>
            </div>
          </div>
          <div className="grid max-w-md grid-cols-1 gap-6 mx-auto auto-rows-fr lg:max-w-full lg:gap-2 xl:gap-6 lg:grid-cols-3">
            <div className="relative z-0 flex flex-col items-center p-8 border rounded-md">
              <span className="absolute top-0 px-6 pt-1 pb-2 font-medium rounded-b-lg bg-violet-600 text-gray-50">
                Personal
              </span>
              <p className="my-6 text-4xl font-bold text-violet-600">FREE</p>
              ...
              <button className="px-4 py-2 mt-4 font-semibold uppercase border rounded-lg md:mt-12 sm:py-3 sm:px-8 border-violet-600">
                Subscribe
              </button>
            </div>
            <div className="relative flex flex-col items-center p-8 border-2 rounded-md border-violet-600 bg-gray-100">
              ...
              <button className="px-8 py-3 mt-12 text-lg font-semibold uppercase rounded bg-violet-600 text-gray-50">
                Subscribe
              </button>
            </div>
            <div className="relative z-0 flex flex-col items-center p-8 border rounded-md bg-gray-100">
              ...
              <button className="px-8 py-3 mt-12 text-lg font-semibold uppercase border rounded border-violet-600">
                Subscribe
              </button>
            </div>
          </div>
